...
export default function ServiceDirectory() {
  ...
  const categories = ['All', 'Stadium Logistics', 'Transit & Shuttle Board', 'Eco-Points Hub', 'Accessibility & Health'];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-zinc-200 dark:border-zinc-800 pb-4">
        <div>
          <h2 className="text-2xl font-black tracking-tight">{t('navServices')}</h2>
          <p className="text-xs text-zinc-500 dark:text-zinc-400">
            Access shuttle schedules, parking lots, ADA accessibility tools, and eco rewards.
          </p>
        </div>
      </div>

      {/* Main layout: directory grid */}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-[#0c0c0f] border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-sm space-y-5">
            <div className="border-b border-zinc-100 dark:border-zinc-900 pb-3">
              ...
              <p className="text-[10px] text-zinc-550 dark:text-zinc-450 font-bold mt-1.5">
              ...
              <div className="space-y-2 text-xs border-t border-zinc-100 dark:border-zinc-900 pt-4">
                ...
                <ul className="space-y-1.5 mt-2">
                  {selectedService.requiredDocs.map((doc, idx) => (
                    <li key={idx} className="flex items-center gap-2 text-zinc-650 dark:text-zinc-400 font-medium">
          ...
          {/* Cup Recycling Simulator (Only visible or active when in Eco-Points category/details) */}
          <div className="bg-gradient-to-br from-emerald-650/15 via-emerald-600/5 to-transparent border border-emerald-500/20 dark:border-emerald-900/30 rounded-2xl p-5 shadow-sm space-y-4">
            <h3 className="font-extrabold text-sm flex items-center gap-2 text-emerald-650 dark:text-emerald-450 leading-tight">
